...
url1 = 'https://drive.google.com/uc?id=1upnIDVGP-wb0HqjkCxdS25E5RFZnGotD'
gdown.download(url1, 'scaler.pkl', quiet=False)

url2 = 'https://drive.google.com/uc?id=1rjkWEQLXiTM1vtQCMzLthRknWgmtH2ya'
gdown.download(url2, 'ensemble_model.pkl', quiet=False)
